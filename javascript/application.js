...
const movieCardTemplateMustache = document.querySelector(
  "#movieCardTemplateMustache"
).innerHTML; // Template content as string
const movieCardListTemplateMustache = document.querySelector(
  "#movieCardListTemplateMustache"
).innerHTML; // Template content as string
...
fetch("https://www.omdbapi.com/?s=harry%20potter&apikey=adf1f2d7")
  ...
  .then((data) => {
    ...
    const moviesList = Mustache.render(
      movieCardListTemplateMustache,
      movieData
    );
